 ...
 */
__inline void tinymt32_next_state(tinymt32_t * random) {
    uint32_t x;
    uint32_t y;
...
#else
__inline static int tinymt32_get_mexp(tinymt32_t * random) {
    return TINYMT32_MEXP;
}
#endif
 ...
 */
__inline static uint32_t tinymt32_temper(tinymt32_t * random) {
    uint32_t t0, t1;
    t0 = random->status[3];
 ...
 */
__inline static float tinymt32_temper_conv(tinymt32_t * random) {
    uint32_t t0, t1;
    union {
	uint32_t u;
	float f;
 ...
 * @return floating point number r (1.0 < r < 2.0)
 */
__inline static float tinymt32_temper_conv_open(tinymt32_t * random) {
    uint32_t t0, t1;
    union {
	uint32_t u;
	float f;
 ...
 */
__inline static uint32_t tinymt32_generate_uint32(tinymt32_t * random) {
 ...
 * @return floating point number r (1.0 <= r < 2.0)
 */
__inline static float tinymt32_generate_float12(tinymt32_t * random) {
    tinymt32_next_state(random);
 ...
 * @return floating point number r (0.0 <= r < 1.0)
 */
__inline static float tinymt32_generate_float01(tinymt32_t * random) {
    tinymt32_next_state(random);
 ...
 * @return floating point number r (0.0 < r <= 1.0)
 */
__inline static float tinymt32_generate_floatOC(tinymt32_t * random) {
    tinymt32_next_state(random);
 ...
 */
__inline static float tinymt32_generate_floatOO(tinymt32_t * random) {
    tinymt32_next_state(random);
